...
public class ItemPrepareZoneBinder extends Item
{
    private final String name = "prepare_zone_binder";

    public ItemPrepareZoneBinder()
    {
    ...
    {
        return new BinderCapabilityProvider(BinderType.PREPARE_ZONE);
    }
